...
import { getByIdProductSuccess } from '../../store/modules/product/actions';
...
export default function RegistrationProduct(values, actions) {
  async function handleSubmit({ values }) {
    try {
      const product = await api.post(`/product/new`);
