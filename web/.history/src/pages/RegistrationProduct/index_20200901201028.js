          ...
          render={({ values }) => (
            <Form className="form-input">
              <div className="header-title">
                ...
                <Field id="categoria" nome="categoria" component="select">
                  <option value="celular">Domingo</option>
                  <option value="tvs">Segunda-feira</option>
                  <option value="notbook">Terça-feira</option>
                  <option value="acessorios">Quarta-feira</option>
                  <option value="acessorios">Quinta-feira</option>
                  <option value="acessorios">Sexta-feira</option>
                  <option value="acessorios">Sábado</option>
                </Field>
