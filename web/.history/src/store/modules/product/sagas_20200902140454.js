...
export default all([
  takeLatest('@product/GET_BYID_PROJECT_REQUEST', getByIdProjectRequest),
  takeLatest('@product/FIND_ALL_PROJECT_REQUEST', findAllProjectRequest),
  takeLatest('@product/DELETE_PROJECT_REQUEST', deleteProjectRequest),
]);
